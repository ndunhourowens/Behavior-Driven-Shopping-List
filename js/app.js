var shopping_list = require('/shopping_list_item');
...
function add_to_shopping_list() {
  document.getElementById('add_shopping_list_item_button').innerHTML = "mother fucker worked!!!!!!!!!";
...
function wtf() {
  ...
  // adding to a list
  document.getElementById('content').innerHTML = "piece of shit";
}
function wtf2() {
  // document.getElementById('content').innerHTML = "mother fucker worked!!!!!!!!!";
  // adding to a list
  document.getElementById('content2').innerHTML = "piece of shit2";
}
